...
| `unicorn/no-keyword-prefix`                                                                                 | unicorn all preset | nothing                                   | oxlint adds it; the one file it hit (`front-end/src/lib/handlers.ts`) carried a disable directive, restore it     |
