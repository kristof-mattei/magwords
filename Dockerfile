...
FROM --platform=${BUILDPLATFORM} rust:1.90.0-slim-trixie@sha256:1219c0b5980e8310eb8e08a7fec9e2159ffc9f166cc9999ddb13604c43cd0eb6 AS rust-base
...
# Front-end (NPM) build
FROM --platform=${BUILDPLATFORM} node:24.9.0-alpine3.22@sha256:77f3c4d1f33c17dfa4af4b0add57d86957187873e313c2c37f52831d117645c8 AS typescript-build
