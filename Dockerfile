...
FROM --platform=${BUILDPLATFORM} rust:1.88.0@sha256:ff3ae3ff3a8b992d1c1c1e7a4dcd52d4aa47c27586f948eff2b452336303f375 AS rust-base
...
# Front-end (NPM) build
FROM --platform=${BUILDPLATFORM} node:22.17.1-alpine@sha256:5539840ce9d013fa13e3b9814c9353024be7ac75aca5db6d039504a56c04ea59 AS typescript-build
